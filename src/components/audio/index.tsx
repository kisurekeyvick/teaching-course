...
export class AudioComponent extends React.PureComponent<IAudioComponentProps, any> {
    public audioDom: any;
    public audioRef: any;
    public audioProgressRef: any;

    constructor(public props: IAudioComponentProps) {
        super(props);
    ...
    public render() {
        return (
            <div className='audio-box'>
                <audio key={this.props.id} src={this.props.resolveUrl} className='native-audio' ref={this.audioRef}/>
                <Row>
